...
// void main(){
//   List<int>myList=[10,30,3,50,60];
//   int target =3;

//   int result = linearSearch(myList, target);
//   if(result!=-1){
//     print("the $target is in the index of $result");
//   }else{
//     print("not found");
//   }
// }
...
//   }else{
//     return binarySearch(arr, target, right, mid+1);
//   }
// }
...
//   if(result!=-1){
//     print("the $target in the index of $result");
//   }else{
//     print("not found"); 
//   }
// }
